...
#CUSTOM_HAL_IMGSENSOR=ov5650mipi_raw_abico ov5650mipi_raw_liteon
CUSTOM_HAL_IMGSENSOR=ov5650mipi_raw_abico ov5650mipi_raw_liteon newport_tv
...
CUSTOM_HAL_MAIN_IMGSENSOR=ov5650mipi_raw_abico
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=ov5650mipi_raw_liteon
...
#//<2012/9/6-NJRTC0000-Cokychen, [8317][DRV]Add for nmi5625 DTV driver
#CUSTOM_KERNEL_IMGSENSOR=ov5650mipi_raw_abico ov5650mipi_raw_liteon
CUSTOM_KERNEL_IMGSENSOR=ov5650mipi_raw_abico ov5650mipi_raw_liteon newport_tv
#//>2012/9/6-NJRTC0000-Cokychen
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=ov5650mipi_raw_abico
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=ov5650mipi_raw_liteon
...
CUSTOM_KERNEL_TOUCHPANEL=mxt224s ektf2k
...
CUSTOM_LK_LCM=nt35310_dsi hx8357c01_dsi
...
# add for change 6620 to 6628 by arima samhuang
...
#<2014/06/06-georgelin, use MTK's OOB
MTK_OOBE_APP=yes
#>2014/06/06-georgelin
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform_mt6575 rel_customer_operator_cu
...
#//<2014/05/30-chenmingfan, [BU2SC00145746][BU2SC00145752], Phone will not pop up"warning"message when increase volume during playing FM Radio.
#MTK_SAFEMEDIA_SUPPORT=no
MTK_SAFEMEDIA_SUPPORT=yes
#//>2014/05/30-chenmingfan
...
MTK_SEC_SECRO_AC_SUPPORT=yes # no
...
CUSTOM_MODEM=hawk35_sec_hspa # hawk35_hspa
...
CUSTOM_KERNEL_LCM=nt35310_dsi hx8357c01_dsi

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=nt35310_dsi hx8357c01_dsi
...
#//<2014/05/09-chenmingfan, [Feature 5028.23] Support Colombian Spanish language on MMCP product
...
MTK_PRODUCT_LOCALES=en_US es_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR hdpi
#//>2014/05/09-chenmingfan
...
#CREATE_PROJECT_INFO=20140321215156
MTK_BUILD_VERNO = 3_010

##########################
# Arima defined features #
##########################
CUSTOM_SUB_BUILD_VERNO			= +0
ARIMA_SVN						= 01
MTK_SEC_MP_KEY                  = KEY_TYPE_MTK # KEY_TYPE_MTK,KEY_TYPE_MP,KEY_TYPE_DEV

ARIMA_HW_VERSION                = HAWK35_EP0
ARIMA_DTV_HW_VERSION            = HAWK35_DTV_EP1
ARIMA_PROJECT_HAWK35            = yes
ARIMA_PROJECT_HAWK35_DTV        = yes
ARIMA_PROJECT_HAWK40            = no
