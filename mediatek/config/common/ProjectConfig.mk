...
################################
# Arima common features defined#
################################
MTK_SERIAL_PORT_DEFAULT_ON = yes
ARIMA_SVN_SUPPORT               = yes
ARIMA_SVN = 01
#//<2014/04/30-georgelin, Implement MOTO-MOTA
# MOTA version
BLUR_PREFIX = Blur_Version
BLUR_PLATFORM_VERSION = 2.26.0
BLUR_OLD_DELTA_VERSION = 2.29.0
BLUR_DELTA_VERSION = 2.26.0-2.29.0
MOTO_MOTA_FEATURE               = yes
#//>2014/04/30-georgelin

#//<2012/09/12-hondahu, MOTO feature 7811 - Special Character Mapping for 7 bit MO-SMS
ARIMA_REGION_PRC                = no
ARIMA_REGION_WE                 = no
ARIMA_REGION_LATAM              = yes
ARIMA_REGION_TWHK               = no
#//>2012/09/12-hondahu
MOTO_QUICK_OFFICE_FEATURE       = yes
#//<2014/05/14-masonmau,Porting 38329, Lifetime Call Timer for UCS.
MOTO_CALLTIMER_FEATURE		= yes
MOTO_INVISIBLE_FEATURE		= no
#//>2014/05/14-masonmau
#//<2014/06/05-georgelin, [38011] Porting the Smart Action feature from Moto main dev branch to MMCP Android products
MOTO_SMARTACTIONS_FEATURE	= yes
#//>2014/06/05-georgelin

#//<2012/9/26-georgelin, [34435] Porting LogMeIn Client
MOTO_LOGMEIN_FEATURE        = yes
#//>2012/9/26-georgelin
#//<2012/10/05-georgelin, [35891] Porting Bug2Go. (for KK)
MOTO_BUG2GO_FEATURE             = yes
#//>2012/10/05-georgelin
#//<2012/10/09-georgelin, [39241][BU2SC00136827][HAWK-425] Porting Civil ALert for LATAM
MOTO_CIVIL_ALERT_FEATURE        = yes
#//>2012/10/09-georgelin
