...
def main(argv):
	...
	print >> sys.stdout,"%s" % item
        ...
        if item == "mediatek/platform/mt6577/kernel":
	    if os.system("cd %s;ln -s mt6577 mt6575" % (os.path.join(destDir,"mediatek/platform/"))):
                print >> sys.stdout, "create 75 symlink error!"
            else:
	        if os.path.exists(os.path.join(sourceDir,"mediatek/platform/mt6575")):
                    os.system("rm -rf %s/mediatek/platform/mt6575" %sourceDir)
