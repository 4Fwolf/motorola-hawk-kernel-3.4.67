...
#//<2012/10/26-15763-ychuang, Enter EngineerMode by MP FLG.
	elsif ($option eq "MTK_SEC_MP_KEY"){
		&gen_java_file ($write_filename, $option, $config_for{$option});
	}
#//>2012/10/26-15763-ychuang

#//<2013/2/27-rickjiau, patch from ArgonMini with ARIMA SVN generation. 
