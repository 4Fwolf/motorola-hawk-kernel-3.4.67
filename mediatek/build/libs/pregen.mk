...
#//<2014/4/14-samhuang, dws file auto select by project configuration.
...
ifneq ($(strip $(ARIMA_DTV_HW_VERSION)), NONE)
	$(hide) cp $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/$(ARIMA_DTV_HW_VERSION).dws $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/codegen.dws
endif
#//>2014/4/14-samhuang
