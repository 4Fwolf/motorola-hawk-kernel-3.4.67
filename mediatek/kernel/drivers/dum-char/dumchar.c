...
//<2014/06/06-samhuang, make patition size same as Hawk35 JB for fix OTA upgrade
#if defined(ARIMA_PROJECT_HAWK35_DTV) || defined(ARIMA_PROJECT_HAWK35)
			...
			//if(!strcmp(PartInfo[i].name,"otp")||!strcmp(PartInfo[i].name,"bmtpool")){
				//dumchar_devices[i].size = (PartInfo[i].start_address & 0x0000FFFF)*128*1024;
			//}
#endif // defined(ARIMA_PROJECT_HAWK35_DTV) || defined(ARIMA_PROJECT_HAWK35)
//>2014/06/06-samhaung
