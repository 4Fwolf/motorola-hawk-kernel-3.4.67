...
/*----------------------------------------------------------------------------*/
//#define HWMSEN_DEBUG
//<2014/04/22-samhaung, porting Hawk's driver
#define I2C_FS_SPEED_MODE	//EricHsieh,2012/9/27, Set the Hwmsen I2C speed mode
//>2014/04/22-samhuang
/******************************************************************************
 * Functions 
******************************************************************************/
...
//<EricHsieh,2012/9/27, Set the Hwmsen I2C speed mode
#ifdef I2C_FS_SPEED_MODE
	client->timing  = MAX_FS_MODE_SPEED;
#else
	client->timing  = MAX_ST_MODE_SPEED;
#endif
//>>EricHsieh,2012/9/27
