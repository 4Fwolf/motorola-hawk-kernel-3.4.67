...
AND_ROMINFO_T  g_ROM_INFO = 
{
    ...
    ,.m_sec_ro_exist                    = ROM_INFO_SEC_RO_EXIST                
                                                            ...
                                                            /* MTK */     
//<20121030-15969-Eric Lin, [secu] Add prod info size in PL.
#if (CFG_BOOT_DEV == BOOTDEV_SDMMC)
    ,.m_sec_ro_offset                   = 
#if defined(PART_SIZE_PRO_INFO)
    PART_SIZE_PRELOADER+PART_SIZE_DSP_BL+PART_SIZE_MBR+PART_SIZE_EBR1+PART_SIZE_PMT+PART_SIZE_NVRAM+PART_SIZE_SECCFG+PART_SIZE_UBOOT+PART_SIZE_BOOTIMG+PART_SIZE_RECOVERY+PART_SIZE_PRO_INFO
#else
...
#else
#if defined(PART_SIZE_PRO_INFO)
    ,.m_sec_ro_offset                   = PART_SIZE_PRELOADER+PART_SIZE_DSP_BL+PART_SIZE_NVRAM+PART_SIZE_SECCFG+PART_SIZE_UBOOT+PART_SIZE_BOOTIMG+PART_SIZE_RECOVERY+PART_SIZE_PRO_INFO
#else
...
#if (CFG_BOOT_DEV == BOOTDEV_SDMMC)
#if defined(PART_SIZE_PRO_INFO)
    ,.m_sec_cfg_offset                  = PART_SIZE_PRELOADER+PART_SIZE_DSP_BL+PART_SIZE_MBR+PART_SIZE_EBR1+PART_SIZE_PMT+PART_SIZE_NVRAM+PART_SIZE_PRO_INFO 
#else
    ,.m_sec_cfg_offset                  = PART_SIZE_PRELOADER+PART_SIZE_DSP_BL+PART_SIZE_MBR+PART_SIZE_EBR1+PART_SIZE_PMT+PART_SIZE_NVRAM
#endif
#else
#if defined(PART_SIZE_PRO_INFO)
    ,.m_sec_cfg_offset                  = PART_SIZE_PRELOADER+PART_SIZE_DSP_BL+PART_SIZE_NVRAM +PART_SIZE_PRO_INFO
#else
