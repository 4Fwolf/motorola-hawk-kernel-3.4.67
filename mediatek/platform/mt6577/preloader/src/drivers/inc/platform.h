...
//<2012/10/1-14506-joshualee, turn on the feature in PRELOADER for the AT+MFLAG function on MT6575
#undef CFG_USB_TOOL_HANDSHAKE
#undef USBDL_DETECT_VIA_AT_COMMAND
#define CFG_USB_TOOL_HANDSHAKE           (1)
#define USBDL_DETECT_VIA_AT_COMMAND      (1)
//>2012/10/1-14506-joshualee
...
#define CFG_UBOOT_MEMADDR               (0x02700000)
