...
#else
__attribute__((section(".mem.region"))) static char g_usb_input_buf[USBTTY_BUFFER_SIZE];
__attribute__((section(".mem.region"))) static char g_usb_output_buf[USBTTY_BUFFER_SIZE];
#endif
