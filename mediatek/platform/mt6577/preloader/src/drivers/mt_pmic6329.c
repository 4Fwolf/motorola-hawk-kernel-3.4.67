...
//<20121002-14530-Eric Lin, [Hawk4.0][secu] Implement the N-SLA hold on function.
//#define BANK_0_HOMEKEY_DEB_MASK 0x1
//#define BANK_0_HOMEKEY_DEB_SHIFT 0x6


int mt_detect_homekey(void)
{
	U32 ret_code = I2C_OK;
	U8 chip_slave_address = mt6329_BANK0_SLAVE_ADDR_WRITE;
    U8 cmd = 0x0C;
