...
extern int mt_detect_homekey(void);
...
#endif
//<20121002-14530-Eric Lin, [Hawk4.0][secu] Implement the N-SLA hold on function.
//<20121009-14979-Eric Lin, [Hawk4.0][secu] Modify the define for usb download key.
#if defined(ARIMA_PROJECT_HAWK40)
//>20121009-14979-Eric Lin
   ...
   if (key == COM_WAIT_KEY)
        ...
        if(get_pmic6329_chip_version() == PMIC6329_E2_CID_CODE)
	{
        ...
        if (1 == mt_detect_homekey())
        {
            print ("home key is pressed\n");
            return true;
        }
		print ("home key not detect.\n");
        return false;
    }
#endif   
//>20121002-14530-Eric Lin
