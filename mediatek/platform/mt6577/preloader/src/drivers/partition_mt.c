...
//<20121009-14987-Eric Lin, [Hawk4.0][secu] Move out some execute code from INT SRAM to the DDRAM area.
#if 0
static pt_resident new_part[PART_MAX_COUNT];
static pt_resident lastest_part[PART_MAX_COUNT];
#else
__attribute__((section(".mem.region"))) char page_buf[LPAGE+128];
__attribute__((section(".mem.region"))) char page_readbuf[LPAGE];

__attribute__((section(".mem.region"))) static pt_resident new_part[PART_MAX_COUNT];
__attribute__((section(".mem.region"))) static pt_resident lastest_part[PART_MAX_COUNT];
#endif
//>20121009-14987-Eric Lin
...
#else
__attribute__((section(".mem.region"))) pt_resident32 lastest_part32[PART_MAX_COUNT];
#endif
//>20121009-14987-Eric Lin
