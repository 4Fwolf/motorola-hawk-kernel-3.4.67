...
#ifndef _MTK_CAM_DEVICE_MANAGER_H_
#define _MTK_CAM_DEVICE_MANAGER_H_
//
...
class String8; //for get/set camera property
#endif
...
#ifdef MTK_NATIVE_3D_SUPPORT
    int             getCameraProperty(String8 const& key, String8& value);
    int             setCameraProperty(String8 const& key, String8 const& value);
...
#ifdef MTK_NATIVE_3D_SUPPORT
    static  int     get_camera_property(String8 const& key, String8& value);
    static  int     set_camera_property(String8 const& key, String8 const& value);
#endif //MTK_NATIVE_3D_SUPPORT
};


}; // namespace android
#endif  //_MTK_CAM_DEVICE_MANAGER_H_
