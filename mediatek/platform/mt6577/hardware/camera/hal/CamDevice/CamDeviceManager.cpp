...
int
CamDeviceManager::
getCameraProperty(String8 const& key, String8& value)
{
...
int
CamDeviceManager::
setCameraProperty(String8 const& key, String8 const& value)
{
...
int 
CamDeviceManager::
get_camera_property(String8 const& key, String8& value)
{
    return CamDeviceManager::getInstance().getCameraProperty(key, value);
}

int
CamDeviceManager::
set_camera_property(String8 const& key, String8 const& value)
{
    return CamDeviceManager::getInstance().setCameraProperty(key, value);
}
