...
#ifndef _MTK_UTILS_INC__CAM_LOG_H_
#define _MTK_UTILS_INC__CAM_LOG_H_
...
#define CAM_LOGV(fmt, arg...)       (void)0
#define CAM_LOGD(fmt, arg...)       (void)0
#define CAM_LOGI(fmt, arg...)       (void)0
#define CAM_LOGW(fmt, arg...)       (void)0
#define CAM_LOGE(fmt, arg...)       (void)0
//
#else
//
...
*
********************************************************************************/
#define CAM_LOGV_IF(cond, ...)      (void)0
#define CAM_LOGD_IF(cond, ...)      (void)0
#define CAM_LOGI_IF(cond, ...)      (void)0
#define CAM_LOGW_IF(cond, ...)      (void)0
#define CAM_LOGE_IF(cond, ...)      (void)0
#define CAM_LOGA_IF(cond, ...)      (void)0
...
#endif  //_MTK_UTILS_INC__CAM_LOG_H_
