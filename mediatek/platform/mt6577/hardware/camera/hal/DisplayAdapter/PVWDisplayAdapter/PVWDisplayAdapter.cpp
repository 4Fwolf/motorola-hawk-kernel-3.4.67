...
*
*******************************************************************************/
//<2014/08/20-georgelin, [HAWK-12160], Patches(Daily)/0819/Patch_2, Time to launch camera from lock screen with no passcode.
#define ENABLE_LOG      (0)
//>2014/08/20-georgelin
...
//
#define PVW_DISP_NATIVE_3D_ENABLE      "Camera.Stereo.3D.Enable"
#define PVW_DISP_NATIVE_3D_ENABLE_N    "0"
#define PVW_DISP_NATIVE_3D_ENABLE_Y    "1"
/******************************************************************************
*
*******************************************************************************/
PVWDisplayAdapter::
...
enableDisplay(bool const isRecordingHint)
{
...
#ifdef MTK_NATIVE_3D_SUPPORT
    bool IsStereo3DEnable = false;
    bool IsNative3DSupport = false;
#endif
    ...
    IsNative3DSupport = (bool)(atoi(value_3d));

    Property::get(PVW_DISP_NATIVE_3D_ENABLE, value_3d, PVW_DISP_NATIVE_3D_ENABLE_N);
    IsStereo3DEnable = (bool)(atoi(value_3d));

    mIsNative3D = IsNative3DSupport && IsStereo3DEnable;
    MY_LOGD("PVW_DISP_NATIVE_3D_SUPPORT(%d) && ENABLE(%d) : mIsNative3D(%d)", IsNative3DSupport, IsStereo3DEnable ,mIsNative3D);
#endif
    //
    ret = true;
lbExit:
