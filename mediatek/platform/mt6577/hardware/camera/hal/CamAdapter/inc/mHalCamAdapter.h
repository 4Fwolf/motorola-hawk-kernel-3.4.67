...
protected:
	...
	//
    sp<IImageBufferPool>    mCShotQvMemPool;
	bool volatile		mbCanCShotQvCB;
    sem_t               mSemCShotQvCB;
    int32_t volatile    mbCShotQvCBThreadAlive;
    pthread_t           mCShotQvCBThreadHandle;
    static void*        _cshotQvCBThread(void* arg);
    void*               cshotQvCBThread();
    void 				cshotQvCallback(); 
