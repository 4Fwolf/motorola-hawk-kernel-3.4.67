...
typedef enum
{
    ACDK_CCT_FEATURE_QUERY_CLI_CMD_CNT, 
    ACDK_CCT_FEATURE_QUERY_CLI_CMDS,
    ...
    ACDK_CCT_OP_FLASH_CONTROL,
    ACDK_CCT_OP_STROBE_RATIO_TUNING,    //cotta : added for strobe ratio tuning
...
typedef VOID (*Func_CB)(VOID* a_pParam); 
...
{
    EIsp_Category_Begin     = 0, 
    EIsp_Category_OB        = EIsp_Category_Begin, 
    EIsp_Category_DM, 
    EIsp_Category_DP, 
    EIsp_Category_NR1, 
    EIsp_Category_NR2, 
...
typedef struct
{
	UINT8 gamma[TOTAL_GAMMA_NO][GAMMA_STEP_NO];
...
typedef struct
{
    ...
    UINT32 u4ISO;
    UINT8  uFrameRate;
    UINT8  uFlareGain;   //128 base
    UINT8  uFlareValue;
    UINT8  uCaptureFlareGain;
    UINT8  uCaptureFlareValue;
    MBOOL   bFlareAuto;
}ACDK_AE_MODE_CFG_T;
