...
#include "audio_hd_record_ap_custom.h"
...
Word16 mLoadRecCompenfilterPara[HD_REC_FIR_INDEX_NUM][WB_FIR_NUM] = {DEFAULT_HD_RECORD_COMPEN_FIR_Coeff};
...
SPELayer::SPELayer()
{
    ...
    //load HD record FIR filter params
    LoadRecCustFIRParam();
}
...
void SPELayer::LoadRecCustFIRParam()
{
    ...
    int c = 0;
    int m = 0;
    int rows = HD_REC_FIR_INDEX_NUM*2+1;    //meet the 48kFIR.txt format
