...
class AudioFtm : public AudioFtmBase
{
    public:
        ...
        void AudFtm_SetHWPtr(AudioYusuHardware *hw, AudioAfe *pAfe, AudioAnalog *pAnaAfe);
        ...
        bool SetLoopbackOff();
        bool SetLoopbackDelay(uint32 delay);
        void SetLoopbackVolume(uint loopbackVolumeLevel, bool setForce);
    ...
    private:
        ...
        uint eCurrentLoopbackMode;
        uint eCurrentLoopbackVolumeLevel;
        ...
        uint32_t loopbackMicGain[GAIN_TABLE_LEVEL];
        uint32_t loopbackSidetoneGain[GAIN_TABLE_LEVEL];
        uint32_t loopbackSpeechGain[NUM_GAIN_OUTPUT_DEVICES][GAIN_TABLE_LEVEL];
