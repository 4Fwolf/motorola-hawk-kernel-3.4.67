...
public:
    ...
    uint32 GetSideTone(int32_t device);

    bool SetFmVolume(int volume);

    //<2013/01/07-NJRTC1111-Cokychen, [8317][DRV]Fix bug: when running DTV, earphone plug in/out will block handset
    bool SetDtvFmVolume(int volume);	
    //>2013/01/07-NJRTC1111-Cokychen
