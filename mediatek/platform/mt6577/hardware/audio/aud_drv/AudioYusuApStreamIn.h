...
//#define DIGITAL_MIC
#define MUTE_APAUDIO_PCM_MS   100
#define MUTE_APAUDIO_PCM_MS_NORMAL   100
...
public:
	...
	status_t ApplyInputMute(void* Buffer , uint32 BufferSize);
	...
	ssize_t	process_frames(void * buffer,ssize_t bytes);
