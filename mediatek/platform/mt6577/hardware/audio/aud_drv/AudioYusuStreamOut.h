...
public:
	...
	unsigned int GetSampleRateInfo();
	unsigned int GetChannelInfo();
...
private:
    ...
    public:
        ...
        virtual status_t init(int filterMode,uint32_t bufferSize)=0;
    ...
    public:
        ...
        virtual status_t init(int filterMode,uint32_t bufferSize);
