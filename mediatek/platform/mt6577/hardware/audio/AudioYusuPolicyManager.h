...
protected:
        ...
        static const VolumeCurvePoint sSpeakerSonificationVolumeCurveDrc[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sDefaultSystemVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sDefaultSystemVolumeCurveDrc[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sHeadsetSystemVolumeCurve[AudioYusuPolicyManager::VOLCNT];
		static const VolumeCurvePoint sDefaultVoiceVolumeCurve[AudioYusuPolicyManager::VOLCNT];
        static const VolumeCurvePoint sSpeakerVoiceVolumeCurve[AudioYusuPolicyManager::VOLCNT];
...
public:
	...
	float computeCustomVoiceVolume(int stream, int index, audio_io_handle_t output, audio_devices_t device);
	float computeCustomVolume(int stream, float &vol,audio_devices_t device);
	void LoadCustomVolume(void);
#ifdef MTK_AUDIO_GAIN_TABLE
public:
	void updateAnalogVolume(audio_io_handle_t output, audio_devices_t device,int delayMs = 0,bool force = false);
private:
    AudioUserCaseManagerInterface* mAudioUCM;
	uint64_t mAnalogGain;
#endif
