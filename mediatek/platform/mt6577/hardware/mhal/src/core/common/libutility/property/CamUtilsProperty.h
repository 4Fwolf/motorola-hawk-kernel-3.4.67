...
#ifndef _MHAL_CAMERA_UTILS_CAMPROPERTY_H_
#define _MHAL_CAMERA_UTILS_CAMPROPERTY_H_
//
 ...
 *
 ******************************************************************************/
bool    get(const String8& key, String8& outValue, const String8& def = String8::empty());
bool    get(char const* key, char* outValue, char const* def = NULL);

};  // namespace Property
};  // namespace MHalCamUtils
};  // namespace android
#endif  //_MHAL_CAMERA_UTILS_CAMPROPERTY_H_
