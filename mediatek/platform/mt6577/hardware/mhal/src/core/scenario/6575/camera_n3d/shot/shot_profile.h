 ...
 ************************************************************************************************/
#ifndef _SHOT_PROFILE_N3D_H_
#define _SHOT_PROFILE_N3D_H_
...
public:
    ShotProfileN3D(char const*const pszTitle, char const*const pszShotName = "")
