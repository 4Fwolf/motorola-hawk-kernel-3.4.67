 ...
 ************************************************************************************************/
#ifndef _SHOT_BASE_H_
#define _SHOT_BASE_H_
...
protected:  //// For JPEG Bit-stream Orientation     
    BufInfo mrRotatedQVBuf; 
...
protected:  ////    
    ...
    virtual BufInfo getBufInfo_ThumbnailEnc() const;     
    virtual BufInfo getBufInfo_quickViewEnc() const; 
 
    //  Quick View.
    virtual MBOOL   makeQuickViewThumbnail(MUINT32& ru4ThumbSize);
    virtual MBOOL   allocateRotatedQuickViewBuf(BufInfo &rBuf); 
    virtual MBOOL   freeRotatedQuickViewBuf(BufInfo &rBuf);
