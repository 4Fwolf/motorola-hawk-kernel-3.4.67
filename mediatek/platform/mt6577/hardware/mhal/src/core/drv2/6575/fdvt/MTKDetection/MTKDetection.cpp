...
void MTKDetection::FDVTMain(MUINT32 image_buffer_address, MUINT32 image_buffer_address1, FDVT_OPERATION_MODE_ENUM fd_state)
{
...
void MTKDetection::FDVTGetFDInfo(MUINT32  FD_Info_Result)
{
    LOGD("MTKDetection FDVTGetFDInfo \n");
}
...
void MTKDetection::FDVTGetICSResult(MUINT32  FD_ICS_Result, MUINT32 FD_Results, MUINT32 Width,MUINT32 Heigh, MUINT32 LCM, MUINT32 Sensor, MUINT32 Camera_TYPE, MUINT32 Draw_TYPE)
{
    LOGD("MTKDetection FDVTGetResult \n");
}
