...
MUINT32 CamCommDoISPSlimShadingLoad(PEEPROM_SHADING_STRUCT pLscTbl)
{
    ...
    MUINT16 i;
    i4XPreGrid = ((pEerom_data->PreRegister.shading_ctrl2&0xF0000000) >> 28) + 2;
    i4YPreGrid = ((pEerom_data->PreRegister.shading_ctrl2&0x0000F000) >> 12) + 2;
    i4XCapGrid = ((pEerom_data->CapRegister.shading_ctrl2&0xF0000000) >> 28) + 2;
    i4YCapGrid = ((pEerom_data->CapRegister.shading_ctrl2&0x0000F000) >> 12) + 2;	
    ...
    tbl_info.reg_info0=pEerom_data->PreRegister.shading_ctrl2;//0x60ea709a;//
    tbl_info.reg_info1=pEerom_data->PreRegister.shading_last_blk;//0xec009a;//
    ...
    tbl_info.reg_info0=pEerom_data->CapRegister.shading_ctrl2; //CaptureREG[1];//0x60ea709a;//
    tbl_info.reg_info1=pEerom_data->CapRegister.shading_last_blk;//CaptureREG[3];//0xec009a;//
