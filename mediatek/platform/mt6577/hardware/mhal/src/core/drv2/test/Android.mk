...
LOCAL_C_INCLUDES:= \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/src/core/drv2/6575/jpeg \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/src/core/pipe/6575/inc \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/src/core/pipe/6575/cameraio \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/src/core/scenario/imagetransform \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/src/core/scenario/camera \
  $(TOP)/$(MTK_PATH_SOURCE)/external/mhal/inc \
  $(TOP)/system/core/include/cutils \
  $(TOP)/$(MTK_PATH_PLATFORM)/kernel/drivers/jpeg \
  $(TOP)/$(MTK_PATH_PLATFORM)/kernel/core/include/mach\
  $(TOP)/$(MTK_PATH_SOURCE)/platform/mt6577/external/mhal/inc/mdp \
