...
#define DRV_DBG(fmt, arg...) XLOGD(LOG_TAG fmt, ##arg)
#define DRV_ERR(fmt, arg...) XLOGE(LOG_TAG "Err: %5d:, "fmt, __LINE__, ##arg)
#else
#define DRV_DBG(a,...)
#define DRV_ERR(a,...)
#endif
...
)
{
    ...
    //MHAL_LOG("\n\n\n[Set Inf]%d\n\n\n", LensPara.rFocusRange.i4InfPos);
    //MHAL_LOG("\n\n\n[Set Mar]%d\n\n\n", LensPara.rFocusRange.i4MacroPos);
    // FIXME, should move to the pipe, not here 
#if 0    
    halMCUSetInf(LensPara.rFocusRange.i4InfPos);
    halMCUSetMacro(LensPara.rFocusRange.i4MacroPos);
#endif   
    }
    m_userCnt++;     
