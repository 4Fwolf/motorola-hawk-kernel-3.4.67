...
public:
    ...
    virtual void setSensorInfo(CAMERA_DUAL_CAMERA_SENSOR_ENUM eDeviceId, MINT32 bZsdOn)=0;

protected:
    virtual ~FlickerHalBase() {};
public:
    virtual MINT32  enableFlickerDetection(MBOOL bEnableFlicker) = 0;
    virtual MINT32 analyzeFlickerFrequency(MINT32 i4LMVcnt, MINT32 *i4LMV_x, MINT32 *i4LMV_y, MINT32 *i4vAFstat=NULL) = 0;
//    virtual MRESULT analyzeFlickerFrequency(MINT32 i4LMVcnt, MINT32 *i4LMV_x, MINT32 *i4LMV_y) = 0;
    virtual MINT32 setWindowInfo(MUINT32 a_u4Width, MUINT32 a_u4Height) = 0;
