...
/*/////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////*/
int MdpPathDummyBrz::Config( struct MdpPathDummyBrzParameter* p_parameter )
{
    ...
    m_mdp_element_list[m_mdp_element_count++] = &me_brz;

    return 0;
}

int MdpPathDummyBrz::_Start( void* pParam )
{
    int ret_val = MDP_ERROR_CODE_OK;



    //0.Begin (For the lock)
...
int MdpPathDummyBrz::_End( void* pParam )
{
