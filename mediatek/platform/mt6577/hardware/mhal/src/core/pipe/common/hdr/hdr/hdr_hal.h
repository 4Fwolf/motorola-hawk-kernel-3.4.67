...
public:
    ...
    virtual MBOOL Do_SwEis(HDR_PIPE_SW_EIS_INPUT_INFO& rHdrPipeSwEisInputInfo);
	...
	virtual MBOOL ConfigMavParam(MUINT32 u4WorkingBuffAddr);
    ...
    virtual MUINT32 MavWorkingBuffSizeGet(MUINT32 ru4SmallImgWidth, MUINT32 ru4SmallImgHeight);
	virtual void QuerySmallImgResolution(MUINT32& ru4Width, MUINT32& ru4Height);
    virtual void QuerySwEisImgResolution(MUINT32& ru4Width, MUINT32& ru4Height);
    virtual MUINT32 SwEisImgBuffSizeGet(void);
