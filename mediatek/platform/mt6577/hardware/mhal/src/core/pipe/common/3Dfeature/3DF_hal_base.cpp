...
MINT32 hal3DFBase::mHal3dfGetResult(MUINT32& MavResult)  
{
	 return 0;
}  
...
/*
MINT32 hal3DFBase::mHalPANO3DAddImg(MavPipeImageInfo* pParaIn)
{                      
	 return 0;           
}	                     
                       
MINT32 hal3DFBase::mHalPANO3DMerge(MUINT32 *MavResult)
{                      
	 return 0;               
}	                     
                       
MINT32 hal3DFBase::mHalPANO3DDoMotion(eis_stat_t EISResult,MUINT32* MotionResult)
{                      
	 return 0;           
}	    	               
                       
MINT32 hal3DFBase::mHalPANO3DWarp(MavPipeImageInfo* pParaIn,MUINT32 *MavResult,MUINT8 ImgNum)
{                      
	 return 0;           
}	                     
                       
MINT32 hal3DFBase::mHalPANO3DGetResult(MUINT32& MavResult)  
{
	 return 0;
} */ 
