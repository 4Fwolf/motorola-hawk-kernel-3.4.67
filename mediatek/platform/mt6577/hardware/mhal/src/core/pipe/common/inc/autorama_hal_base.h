...
#define AUTORAMA_MAX_IN_WIDTH                 (640)                       // max input image width
#define AUTORAMA_MAX_IN_HEIGHT                (480)                       // max input image height
#define AUTORAMA_MAX_OUT_WIDTH                (3800)                      // max output image width
#define AUTORAMA_WORKING_BUFFER_SIZE          (AUTORAMA_MAX_OUT_WIDTH*AUTORAMA_MAX_IN_HEIGHT*3/2)      // working buffer size
...
public:
    ...
    //
    /////////////////////////////////////////////////////////////////////////    
    virtual MINT32 mHalAutoramaInit(MTKPipeAutoramaEnvInfo AutoramaInitInData) {return 0;}
