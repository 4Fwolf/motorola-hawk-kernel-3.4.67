...
typedef struct
{
    MUINT16 u2SwEisImgWidth;		// eis_image_width;
    MUINT16 u2SwEisImgHeight;		// eis_image_height;
    MUINT32 pSwEisImgBufAddr[HDR_MAX_IMAGE_NUM];	// eis_image_addr;
} HDR_PIPE_SW_EIS_INPUT_INFO, *P_HDR_PIPE_SW_EIS_INPUT_INFO;
...
public:
    ...
    virtual MBOOL Do_SwEis(HDR_PIPE_SW_EIS_INPUT_INFO& rHdrPipeSwEisInputInfo) = 0;
	...
	virtual MBOOL ConfigMavParam(MUINT32 u4WorkingBuffAddr) = 0;
    ...
    virtual MUINT32 MavWorkingBuffSizeGet(MUINT32 ru4SmallImgWidth, MUINT32 ru4SmallImgHeight) = 0;
	virtual void QuerySmallImgResolution(MUINT32& ru4Width, MUINT32& ru4Height) = 0;
    virtual void QuerySwEisImgResolution(MUINT32& ru4Width, MUINT32& ru4Height) = 0;
    virtual MUINT32 SwEisImgBuffSizeGet(void) = 0;
