...
public:
    ...
    virtual void FDVTMain(MUINT32 image_buffer_address, FDVT_OPERATION_MODE_ENUM fd_state){};
    virtual void FDVTReset(void) {};
    virtual MUINT32 FDVTGetResultSize(void) {return 0;};
    virtual MUINT8 FDVTGetResult(MUINT32 FD_result_Adr) {return 0;};
    ...
    virtual MUINT8 FDVTGetSDResult(MUINT32 FD_result_Adr) {return 0;};
    #endif
private:
