...
typedef struct
{
	...
	// 2012-10
	MUINT32 open_default_crop ; // 1: using default cropping, 0: no, default cropping, default 0
	MINT32 default_cropping ; // default cropping position, according to image size and pannel size, default -10

	MUINT32 open_strong_stabilizer ; // 1: using moving threshold, 0: no, default 1
	MUINT32 moving_threshold_x ; // define the threshold for x moving, default 5
	MUINT32 moving_threshold_y ; // define the threshold for y moving, default 3

	MUINT32 open_histrical_ref ; // 1: using histrical reference, 0: no, default 1
	//
