...
// 2012-10
#define DEFAULT_CROPPING_VALUE		-10
#define MOVING_THRESHOLD_X_VALUE    5	// > 0
#define MOVING_THRESHOLD_Y_VALUE    3	// > 0
#define OPEN_HISTRICAL_REF			1	// 1:on, 0:off
#define OPEN_STRONG_STABILIZER		1	// 1:on, 0:off
#define OPEN_DEFAULT_CROP			0	// 1:on, 0:off
//

#define GIA_LOG_BUFFER_SIZE 644//636 2012-10
/*****************************************************************************
	Class Define
******************************************************************************/
