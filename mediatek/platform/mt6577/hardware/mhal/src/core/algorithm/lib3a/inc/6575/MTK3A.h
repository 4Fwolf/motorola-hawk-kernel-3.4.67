...
public:
	...
	static void convertFlashExpPara(int flashEngRatio_x10, int minAfeGain_x1024, 
			int bv0_x1024, int bv1_x1024,
			int  exp1, int  afeGain1_x1024, int  ispGain1_x1024, 
			int* exp2, int* afeGain2_x1024, int* ispGain2_x1024);
