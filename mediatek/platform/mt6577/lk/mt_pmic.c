...
//<2014/04/07-samhuang, Merge Hawk35 driver to KK
#if defined(HAWK35_EP0)
	ret=pmic_config_interface(BANK0_DIGLDO_CON1C, 0x6, BANK_0_RG_VCAMD_VOSEL_MASK, BANK_0_RG_VCAMD_VOSEL_SHIFT);		
#else
...
//<2014/04/07-samhuang, [Hawk40] Add "HAWK40_EP1" feature.
#if defined(HAWK35_EP0) || defined(HAWK40_EP1)
	ret=pmic_config_interface(BANK0_DIGLDO_CON30, 0x2, BANK_0_RG_VGP2_VOSEL_MASK, BANK_0_RG_VGP2_VOSEL_SHIFT); /* 1.8V */
#elif defined(HAWK40_EP0)
	ret=pmic_config_interface(BANK0_DIGLDO_CON30, 0x6, BANK_0_RG_VGP2_VOSEL_MASK, BANK_0_RG_VGP2_VOSEL_SHIFT); /* 3.3V */
#else
...
//<2014/04/07-samhuang, porting hawk's driver
	...
	ret=pmic_config_interface(BANK0_DIGLDO_CON1F, 0x1, BANK_0_RG_VCAM_IO_EN_MASK, BANK_0_RG_VCAM_IO_EN_SHIFT );
	//printf("[PMIC] mtkfb - Turn on VGP2(1.8V) and VCAM_IO(2.8V)\n");
#endif
#if defined(HAWK35_EP0)
	ret=pmic_config_interface(BANK0_DIGLDO_CON1C, 0x1, BANK_0_RG_VCAMD_EN_MASK, BANK_0_RG_VCAMD_EN_SHIFT);		
#endif
//>2014/04/07-samhuang

	//<2014/04/07-samhuang, Disable the VCAMERA related LDO at init.
   ...
   //<2014/04/07-samhuang, Modify camera reset signal
	ret=pmic_config_interface(BANK0_DIGLDO_CON30, 0x0, BANK_0_RG_VGP2_EN_MASK, BANK_0_RG_VGP2_EN_SHIFT );
   //>2014/04/07-samhuang
	//>2014/04/07-samhuang
}
...
//<2014/04/07-samhuang, improve KPI-0092 to add VIB before show logo.
void upum_vibr_sel(kal_uint32 vol)//Con33 bit[4~6] volt 3'b 0:1.3v; 1:1.5v; 2:1.8v; 3:2.5v; 4:2.8v; 5:3.0v; 6:3.3v;7:3.3v
{
	kal_uint32 ret = 0;
	ret = pmic_config_interface((kal_uint8)(BANK0_LDO_VIBR1),
		(kal_uint8)(vol),
		(kal_uint8)(BANK_0_RG_VIBR_VOSEL_MASK),
		(kal_uint8)(BANK_0_RG_VIBR_VOSEL_SHIFT)
	);
	//return ret;
}

void upum_vibr_enable(kal_uint32 en)//CON33 bit[0] 1'b 1:enable; 0:disable
{
	kal_uint32 ret=0;
	ret=pmic_config_interface((kal_uint8)(BANK0_LDO_VIBR1),
		(kal_uint8)(en),
		(kal_uint8)(BANK_0_RG_VIBR_EN_MASK),
		(kal_uint8)(BANK_0_RG_VIBR_EN_SHIFT)
	);
	//return ret;
}
void lk_vibr_enable(void)
{
	ulong vibr_timer = 0;
	...
	while(get_timer(vibr_timer) < 100 /*ms*/);
	upum_vibr_enable(0);
}
//>2014/04/07-samhuang
