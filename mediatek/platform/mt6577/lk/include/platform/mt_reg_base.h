...
#define EMI_BASE            (IO_PHYS + 0x00003000)
...
#define DRAM_PHY_ADDR           (0x00000000)
/**************************************************
 *                   F003 0000                    *
 **************************************************/
 ...
 *                   F010 0000                    *
 **************************************************/
#define USB_BASE            (IO_PHYS + 0x01210000) // Jau leave the definition to make compile pass
#define USBSIF_BASE	    (IO_PHYS + 0x01260000) // This is for MT6577 Only, it is different on MT658X
...
#define CFG_RAMDISK_LOAD_ADDR           (RIL_SIZE + 0x4000000)
