...
//<2013/03/05-georgelin, For fix [BU2SC00143827][HAWK-8167], Device frozen in Navigation (gps)
#define DATA_FREE_SIZE_TH_DEFAULT (200*1024*1024)//(50*1024*1024)
//>2013/03/05-georgelin
