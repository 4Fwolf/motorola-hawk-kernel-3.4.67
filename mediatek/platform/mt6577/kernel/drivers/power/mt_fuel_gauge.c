...
extern CHARGER_TYPE CHR_Type_num;
...
//<2012/12/14-18780-jessicatseng, [Hawk 4.0][BU2SC00139453] MS battery level change error (E.G. from 15% change to52%)
//<2012/12/26 Albert remove 18780-jessicatseng set gFG_current 600 mA .

#if defined(ARIMA_PROJECT_HAWK40)
/*
    if((gFG_booting_counter_I_FLAG == 1) && (CHR_Type_num == CHARGER_UNKNOWN) && (gFG_current < 6000))
    {
    	gFG_current = 6000;	
    }
*/    	
...
//<2012/11/22-17513-jessicatseng, [Hawk 4.0] Add ZCV table for LG cell
    ...
    {
        low_temperature = (-10);
		low_Q_max = MOTO_BATTERY_Q_MAX_NEG_10[g_MOTO_Battery_ID];	//Q_MAX_NEG_10_H_CURRENT;
        high_temperature = TEMPERATURE_T1;
		high_Q_max =  MOTO_BATTERY_Q_MAX_POS_0[g_MOTO_Battery_ID];		//Q_MAX_POS_0_H_CURRENT;
    ...
    {
        low_temperature = TEMPERATURE_T1;
		low_Q_max =  MOTO_BATTERY_Q_MAX_POS_0[g_MOTO_Battery_ID];	//Q_MAX_POS_0_H_CURRENT;
        high_temperature = TEMPERATURE_T2;
		high_Q_max =  MOTO_BATTERY_Q_MAX_POS_25[g_MOTO_Battery_ID];	//Q_MAX_POS_25_H_CURRENT;
    ...
    {
    	low_temperature  = TEMPERATURE_T2;
		low_Q_max =  MOTO_BATTERY_Q_MAX_POS_25[g_MOTO_Battery_ID];	//Q_MAX_POS_25_H_CURRENT;
        high_temperature = TEMPERATURE_T3;
		high_Q_max =  MOTO_BATTERY_Q_MAX_POS_50[g_MOTO_Battery_ID];	//Q_MAX_POS_50_H_CURRENT;
...
//<2012/11/22-17513-jessicatseng, [Hawk 4.0] Add ZCV table for LG cell
    ...
    {
        low_temperature = (-10);
        low_Q_max = MOTO_BATTERY_Q_MAX_NEG_10_H_CURRENT[g_MOTO_Battery_ID];
        high_temperature = TEMPERATURE_T1;
        high_Q_max = MOTO_BATTERY_Q_MAX_POS_0_H_CURRENT[g_MOTO_Battery_ID];
    ...
    {
        low_temperature = TEMPERATURE_T1;
        low_Q_max = MOTO_BATTERY_Q_MAX_POS_0_H_CURRENT[g_MOTO_Battery_ID];
        high_temperature = TEMPERATURE_T2;
        high_Q_max = MOTO_BATTERY_Q_MAX_POS_25_H_CURRENT[g_MOTO_Battery_ID];
    ...
    {
        low_temperature  = TEMPERATURE_T2;
        low_Q_max = MOTO_BATTERY_Q_MAX_POS_25_H_CURRENT[g_MOTO_Battery_ID];
        high_temperature = TEMPERATURE_T3;
        high_Q_max = MOTO_BATTERY_Q_MAX_POS_50_H_CURRENT[g_MOTO_Battery_ID];
...
//<2012/12/21-19079-jessicatseng, [Hawk 4.0] To fix some variables doesn't separate for different MOTO battery
#if defined(CHK_BATTERY_ID__MOTO_ID) && defined(BATTERY_PACK_EG30)
		g_MOTO_Battery_ID = Get_MOTO_Battery_Vender();
		
	if (Enable_FGADC_LOG == 1){
	 xlog_printk(ANDROID_LOG_INFO, "Power/Battery", "g_MOTO_Battery_ID = %d\n", g_MOTO_Battery_ID);
	}
		...
		if(g_MOTO_Battery_ID == 0x01)
		{
			 saddles = fgauge_get_saddles();
				...
				memcpy(battery_profile_t0, battery_profile_t0_SDI, sizeof(BATTERY_PROFILE_STRUC) * saddles);
				memcpy(battery_profile_t1, battery_profile_t1_SDI, sizeof(BATTERY_PROFILE_STRUC) * saddles);
				memcpy(battery_profile_t2, battery_profile_t2_SDI, sizeof(BATTERY_PROFILE_STRUC) * saddles);
				memcpy(battery_profile_t3, battery_profile_t3_SDI, sizeof(BATTERY_PROFILE_STRUC) * saddles);
				memcpy(r_profile_t0, r_profile_t0_SDI, sizeof(R_PROFILE_STRUC) * saddles);
				memcpy(r_profile_t1, r_profile_t1_SDI, sizeof(R_PROFILE_STRUC) * saddles);
				memcpy(r_profile_t2, r_profile_t2_SDI, sizeof(R_PROFILE_STRUC) * saddles);
				memcpy(r_profile_t3, r_profile_t3_SDI, sizeof(R_PROFILE_STRUC) * saddles);
	}								
#endif	    
...
#if defined(CHK_BATTERY_ID__MOTO_ID) && defined(BATTERY_PACK_EG30)
    gFG_BATT_CAPACITY_init_high_current = MOTO_BATTERY_Q_MAX_POS_25_H_CURRENT[g_MOTO_Battery_ID];
    //gFG_BATT_CAPACITY_aging = gFG_BATT_CAPACITY_init_high_current;
    gFG_BATT_CAPACITY_aging = MOTO_BATTERY_Q_MAX_POS_25[g_MOTO_Battery_ID];
#else
    gFG_BATT_CAPACITY_init_high_current = Q_MAX_POS_25_H_CURRENT;
    //gFG_BATT_CAPACITY_aging = gFG_BATT_CAPACITY_init_high_current;
    gFG_BATT_CAPACITY_aging = Q_MAX_POS_25;
#endif    
//>2012/12/21-1079-jessicatseng
