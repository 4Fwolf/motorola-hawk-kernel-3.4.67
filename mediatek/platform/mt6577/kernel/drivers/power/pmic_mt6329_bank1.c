...
//<2014/04/07-samhuang, Merge Hawk35 driver to Jelly Bean
...
#endif
//>2014/04/07-samhuang
//<2014/04/07-samhuang, porting argonmini_6577/6575 driver
#if defined(HAWK35_EP0)
...
#ifndef CONFIG_MTK_EXTBACKLIGHT
...
#endif
//>2014/04/07-samhuang
//<2014/04/07-samhuang,Modify vibrator to 3.3V in HAWK40 project.
#if defined(HAWK40_EP0) || defined(HAWK40_EP1) || defined(HAWK40_EP2)
    ret=pmic_config_interface(BANK0_DIGLDO_CON33, 0x6, BANK_0_RG_VIBR_VOSEL_MASK, BANK_0_RG_VIBR_VOSEL_SHIFT); //3.3V
#else
...
//>2014/04/07-samhuang
	...
	//<2014/04/07-samhuang, Disable the VN12_2 related LDO at init.
	ret=pmic_config_interface(BANK0_DIGLDO_CON5, 0x0, BANK_0_VM12_2_EN_MASK, BANK_0_VM12_2_EN_SHIFT); /* VM12_2: Not use => Disable */
	//>2014/04/07-samhuang
}
...
//<2012/10/02 ShermanWei,Marked for charger controlled by framework
/*
