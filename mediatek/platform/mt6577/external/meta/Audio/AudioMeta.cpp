...
//      mLad->LAD_SwitchVCM(true);
    ...
    mAudFtm->AudFtm_SetHWPtr(NULL, mAsmReg, mAnaReg);
...
{
    int WriteCount = 0;
    //android::SetCustParamToNV( (AUDIO_CUSTOM_PARAM_STRUCT *)audio_par);   //ship mark for bring up
    return WriteCount;
}
...
{
    int ReadConut = 0;
    //android::GetCustParamFromNV( (AUDIO_CUSTOM_PARAM_STRUCT *)audio_par);   //ship mark for bring up
...
{
    int WriteCount = 0;
    android::SetAudioCompFltCustParamToNV( AUDIO_COMP_FLT_AUDIO,(AUDIO_ACF_CUSTOM_PARAM_STRUCT *)audio_par);
    return WriteCount;
}
...
{
    int ReadConut = 0;
    android::GetAudioCompFltCustParamFromNV( AUDIO_COMP_FLT_AUDIO,(AUDIO_ACF_CUSTOM_PARAM_STRUCT *)audio_par);
...
{
    int WriteCount = 0;
    android::SetAudioCompFltCustParamToNV( AUDIO_COMP_FLT_HEADPHONE,(AUDIO_ACF_CUSTOM_PARAM_STRUCT *)audio_par);
    return WriteCount;
}
...
{
    int ReadConut = 0;
    android::GetAudioCompFltCustParamFromNV( AUDIO_COMP_FLT_HEADPHONE,(AUDIO_ACF_CUSTOM_PARAM_STRUCT *)audio_par);
