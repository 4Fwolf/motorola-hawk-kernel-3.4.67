...
*******************************************************************************/
//gionee pengchao 20120326 added for CR00555806 start    
#if defined(GN_MTK_BSP)  
#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 20 
#else
//<2012/11/28 alberthsiao-17860,camera quality tuning for Hawk40
#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 50 //10
//>2012/11/28 alberthsiao-17860
#endif
//gionee pengchao 20120326 added for CR00555806 end
...
{
//<2012/12/17,daisy zang,[8317][Camera]MTK patch for continous shot(flash lamp on)ARIMA77_JB_ALPS.JB.MP.V1.13_P26
	//return FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X;
	return 10;
//>2012/12/17,daisy zang
}
