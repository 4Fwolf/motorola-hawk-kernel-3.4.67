...
//<2013/01/29-ClarkLin-modify camera PDN/RST signal
			GPIO_OUT_ONE,
                        GPIO_OUT_ZERO,
//                        GPIO_OUT_ONE,
//>2013/01/29-ClarkLin
...
//>2013/01/29-ClarkLin
        ...
        //<2012/11/30-kylechang, Delay 0ms to fit OV5650 power sequence before turning on GPIO#35
        //mdelay(1);
        //>2012/11/30-kylechang
		//3.
		//<2012/09/24-kylechang, Disable CAMERA_POWER_VCAM_D (Controled by GPIO35)
		/*
		...
		*/
		...
		mt_set_gpio_out(GPIO35,GPIO_OUT_ONE);		
		//>2012/09/24-kylechang
		//4.
