...
//<2012/11/07-16432-alberthsiao,Smooth AF control for Hawk40
static int g_sr = 15; //3
//>2012/11/07-16432-alberthsiao
//<2014/5/26-kylechang, Fix compiler error for Android  KK
...
inline static int moveOV8835AF(unsigned long a_u4Position)
{
    ...
    if (g_s4OV8835AF_Opened == 1)
    {
        ...
        ret = s4OV8835AF_ReadReg(&InitPos); // MTK Reference Design
...
OV8835AFDB("[OV8835AF] move [curr] %d [target] %d\n", g_u4CurrPosition, g_u4TargetPosition);
            ...
            if(s4OV8835AF_WriteReg((unsigned short)g_u4TargetPosition) == 0) // MTK Reference Design		
            {
                spin_lock(&g_OV8835AF_SpinLock);		
