...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		// enable tearing-free
//<2012/11/12-16742-stevenchen, [Hawk40] Enable tearing function.
		params->dbi.te_mode 			= LCM_DBI_TE_MODE_VSYNC_ONLY;	//LCM_DBI_TE_MODE_DISABLED; 
//>2012/11/12-16742-stevenchen
...
//<2012/11/21-17366-stevenchen, [Hawk40] Fix LCM tearing issue.
		params->dsi.pll_div1=34; //30 //26 //34		// fref=26MHz, fvco=fref*(div1+1)	(div1=0~63, fvco=500MHZ~1GHz)
//>2012/11/21-17366-stevenchen
