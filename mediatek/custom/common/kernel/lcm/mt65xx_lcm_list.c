...
//<2012/09/13 Yuting Shih. Add and merge Hawk35 device driver to Jelly Bean.
#if defined( NT35310_DSI )
extern LCM_DRIVER nt35310_dsi_lcm_drv;
#endif
#if defined( HX8357C01_DSI )
extern LCM_DRIVER hx8357c01_dsi_lcm_drv;
#endif
//>2012/09/13 Yuting Shih.
//<2012/11/02-16156-stevenchen, [Hawk40] Add Orise OTM8009A LCM driver.
#if defined( OTM8009A_DSI_VDO )
extern LCM_DRIVER otm8009a_dsi_vdo_lcm_drv;
#endif
//>2012/11/02-16156-stevenchen

#if defined( OTM8018B_VDO_SPI )
extern LCM_DRIVER otm8018b_vdo_spi_lcm_drv;
#endif
...
//<2012/11/02-16156-stevenchen, [Hawk40] Add Orise OTM8009A LCM driver.
	...
	#if defined(OTM8018B_VDO_SPI)
		&otm8018b_vdo_spi_lcm_drv,
	#endif
#else
	#if defined(OTM8009A_DSI_VDO)	
		&otm8009a_dsi_vdo_lcm_drv, 
	#endif
#endif /* HAWK40_EP0 */
//>2012/11/02-16156-stevenchen
};
