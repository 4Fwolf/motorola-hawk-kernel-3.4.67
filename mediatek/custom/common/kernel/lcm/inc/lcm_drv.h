...
//<2012/09/19-14141-stevenchen, [Hawk4.0] Implement LCM auto detection.
	...
	//#define LCM_DETECT_BY_PIN
	#define LCM_DETECT_BY_ID
	//#define LCM_DETECT_BY_BOTH

	#if ( defined(LCM_DETECT_BY_PIN) || defined(LCM_DETECT_BY_BOTH) )
		#define GPIO_LCM_ID_PIN	101
	#endif
#endif /* ARIMA_PROJECT_HAWK40 */
