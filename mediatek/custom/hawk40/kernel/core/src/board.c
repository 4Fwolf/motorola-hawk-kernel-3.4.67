...
/*=======================================================================*/
//<2013/03/27-samhuang, remove WP PIN check, due to SD card issue in WJ factory
//<2012/09/05-13603-stevenchen, [Hawk4.0] Add micro SD hot-plug feature
#if defined(ARIMA_PROJECT_HAWK40)
#define MSDC_SDCARD_FLAG  (MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_CD_PIN_EN | MSDC_REMOVABLE)//(MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_HIGHSPEED | MSDC_CD_PIN_EN | MSDC_REMOVABLE)
#else
#define MSDC_SDCARD_FLAG  (MSDC_SYS_SUSPEND | MSDC_HIGHSPEED) //(MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_HIGHSPEED)  //| MSDC_CD_PIN_EN | MSDC_REMOVABLE 
#endif /* ARIMA_SD_HOT_PLUG_SUPPORT */
//>2012/09/05-13603-stevenchen
//>2013/03/27-samhuang
...
struct msdc_hw msdc1_hw = {
    ...
    .data_offset    = 0,
//<2012/09/05-13603-stevenchen, [Hawk4.0] Add micro SD hot-plug feature
    .flags          = MSDC_SDCARD_FLAG,	//MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_HIGHSPEED|MSDC_SPE,
//>2012/09/05-13603-stevenchen
    .dat0rddly		= 0,
	.dat1rddly		= 0,
	.dat2rddly		= 0,
	...
	//< 2012-10-24, AngusLi, make wifi function work well in some special Hawk4.0 devices
    //< 2012/10/05-AngusLi, make wifi funtion work on Hawk40
	...
	struct msdc_hw msdc3_hw = {
	    ...
	    .data_pins      = 4,
	    .data_offset    = 0,
	    .flags          = MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_TABDRV,//MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED|MSDC_TABDRV|MSDC_INTERNAL_CLK,//| MSDC_HIGHSPEED
	    .dat0rddly		= 0,
		.dat1rddly		= 0,
		.dat2rddly		= 0,
		.dat3rddly		= 0,
