...
#if defined(OV5650MIPI_RAW_ABICO)
    RAW_INFO(OV5650MIPI_ABICO_SENSOR_ID, SENSOR_DRVNAME_OV5650MIPI_RAW_ABICO, NULL), 
#endif
#if defined(OV5650MIPI_RAW_LITEON)
    RAW_INFO(OV5650MIPI_LITEON_SENSOR_ID, SENSOR_DRVNAME_OV5650MIPI_RAW_LITEON, NULL), 
#endif
//>2013/01/07-ClarkLin
